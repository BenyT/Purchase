...
@implementation TableOfContentsCell
...
+ (instancetype)cellWithTableView:(UITableView *)tableView
{
    ...
    TableOfContentsCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        cell = [[TableOfContentsCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
        //取消选中状态
